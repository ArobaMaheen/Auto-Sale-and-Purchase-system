 ...
 */
public class CarDetails2 implements Initializable {
...
connection c;
    ...
    CarDetails2Model obj =new CarDetails2Model();
    /**
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       String a=obj.ini1(imgg, dadd, asss, CarId, Name, Model, CarColor, TankCapacity, FuelType, CarsOwner, NumberPlate, Date, Mileage, Location, Price);

    obj.ini2(imgs, SellerName, PhoneNo, Address);
    
               obj.ini3(InformerName,a);
           
   obj.ini4(imgs1, SellerName1, PhoneNo1, Address1);
        }catch(Exception e){
            e.printStackTrace();
        }
...
Model.ReporModel rm=new Model.ReporModel();
    @FXML
    private void fullreport(ActionEvent event) {
        rm.aa(Name, CarColor, TankCapacity,FuelType,Model,CarsOwner,Date,Mileage,NumberPlate,Location,SellerName1,Address1,PhoneNo,Address,SellerName,PhoneNo1,Price,dadd);
    }
